...
ii stringMatching(string P){ //O(sz(P)lgn)t
...
int main() {
    ...
    while(scanf("%s",T) != EOF){//escaneo de string
        n = strlen(T);
        s = T;
        s+= '$';//indicador del termino de string
        constructsa();//costructor de suffyx array
...
suffix array algorithm: rescatado de clase practica 
*/